...
if __name__ == "__main__":
    # Example usage
    producer = KafkaProducerClient(topic="customer-topic")
    ...
    # ]
    valid_messages = [
        # {"transaction_id": 1001, "customer_id": 1, "product_id": 501, "date": "2025-02-15", "Quantity": 10, "amount": 99.98 }
        
        {"customer_id": 202, "name": "Customer 202", "email": "customer202@example.com", "phone": "555-02002", "address": "501 Lane St", "created_date": "2025-01-24"}
